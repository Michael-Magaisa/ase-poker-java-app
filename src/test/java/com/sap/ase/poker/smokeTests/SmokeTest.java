...
public class SmokeTest {
  ...
  @Autowired protected TableController underTest;
  ...
  protected PlayerDto getCurrentPlayerState(
      PlayerDto currentPlayerDto, GetTableResponseDto result) {
    return result.getPlayers().stream()
        .filter(playerDto -> playerDto.getId().equals(currentPlayerDto.getId()))
        .findFirst()
        .get();
  }
