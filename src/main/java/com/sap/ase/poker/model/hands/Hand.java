...
public abstract class Hand implements Comparable<Hand> {
  ...
  protected abstract List<Card> findRelevantCards(List<Card> cards);
  ...
  protected List<Card> findKickerCards(List<Card> cards) {
    ...
    return potentialKickerCards.subList(
        potentialKickerCards.size() - amountOfNeededKickerCards, potentialKickerCards.size());
  }
  ...
  protected List<Card> sortCardsDescending(List<Card> cards) {
    List<Card> sortedAscending = sortCardsAscending(cards);
